...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      ></div>
      <aside
        className={`overflow-y-auto fixed top-0 left-0 h-full bg-background border-r border-border p-4 z-40 flex flex-col shadow-lg transition-transform duration-300 ease-in-out
